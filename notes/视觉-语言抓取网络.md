...
```
python train_network.py --dataset grasp-anywhere --dataset-path /home/wjj2080/Datasets/Grasp-Anything --add-file-path data/grasp-anything++/seen --description training_grasp_anything++_lggcnn --use-depth 0 --seen 1 --network lggcnn
```
...
```
python train.py --root /home/wjj2080/GraspSAM/datasets/Jacquard_Dataset --sam-encoder-type vit_t --seen --validate --save
```
...
```
torchrun --nproc_per_node=3 train_ddp.py --root /home/wjj2080/GraspSAM/datasets/Jacquard_Dataset --sam-encoder-type vit_t --seen --validate --save
```
...
```
python train.py --dataset-name grasp_anything --root /home/wjj2080/Datasets/Grasp-Anything --sam-encoder-type vit_t --seen --validate --save
```
...
```
python eval.py --gpu-num 0 --dataset_name jacquard --root /home/wjj2080/Datasets/Jacquard_Dataset --ckp_path /home/wjj2080/GraspSAM/final_result/total_vit_t_default/jacquard/2025-12-03-13-15-36/epoch1.pth 
```
